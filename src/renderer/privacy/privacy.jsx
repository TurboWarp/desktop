...
ReactDOM.render((
  ...
  <main>
    ...
    <p>Scratch extensions that require Wi-Fi (such as Translate, Text to Speech, LEGO, micro:bit, etc.) may connect to the Scratch API to implement these features. <a href="https://scratch.org/privacy_policy/" target="_blank">Refer to the Scratch privacy policy for more information</a>. The Translate extension may instead make requests to a TurboWarp API, which may then forward your request to the Scratch API and log the message being translated and the result for caching and performance.</p>

    <h2>Packager</h2>
    <p>The packager may contact the Scratch API to download projects. See the <a href="https://scratch.org/privacy_policy/">Scratch privacy policy</a> for more information. If you configure the packager to package a project from a remote URL, you are subject to the privacy practices of that particular website. The packager may download large files such as Electron binaries from a remote server; these requests are not logged.</p>

    <h2>Output of packager ("packaged projects")</h2>
    {/* Keep in sync with https://packager.turbowarp.org/privacy.html */}
    <p>If the packaged project uses extensions that require Wi-Fi such as Translate, Text to Speech, LEGO, and micro:bit, then the project may connect to the Scratch API to implement these features. <a href="https://scratch.org/privacy_policy/">Refer to the Scratch privacy policy for more information</a>.</p>
